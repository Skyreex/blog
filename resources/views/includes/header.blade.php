            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="{{ route('tp4.index') }}">Accueil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('tp4.apropos') }}">A Propos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('tp4.packages.index') }}">Packages</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
        <div x-data="{ open: true }"
            ...
            <div class="flex flex-row items-center justify-between p-4">
                <a href="{{ route('home') }}"
                    class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">Skyreex</a>
            ...
            <nav :class="{ 'flex': open, 'hidden': !open }"
                ...
                <a class="nav__link" href="{{ route('bmi.index') }}">BMI</a>
