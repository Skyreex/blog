      ...
      <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
          <div class="w-full md:w-1/2">
            ...
            {{--                  </svg>--}}
            {{--                </div>--}}
            {{--                <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm--}}
            ...
            @foreach($stagiaires as $stagiaire)
              <tr class="border-b dark:border-gray-700">
                ...
                <td class="px-4 py-3 flex items-center justify-end">
                  ...
                  {{--                  @else--}}
                  {{--                    <a href="#">--}}
                  {{--                      <svg class="hover:text-emerald-950 w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg"--}}
                  {{--                           viewbox="0 0 20 20"--}}
                  {{--                           fill="currentColor" aria-hidden="true">--}}
                  {{--                        <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"/>--}}
                  {{--                        <path fill-rule="evenodd" clip-rule="evenodd"--}}
        ...
        {{--                  dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">1</a>--}}
        {{--            </li>--}}
        {{--            <li>--}}
        {{--              <a href="#"--}}
        {{--                 class="flex items-center justify-center text-sm py-2 px-3 leading-tight text-gray-500 bg-white border--}}
        {{--                 border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700--}}
        {{--                 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">2</a>--}}
        {{--            </li>--}}
        {{--            <li>--}}
        {{--              <a href="#" aria-current="page"--}}
        {{--                 class="flex items-center justify-center text-sm z-10 py-2 px-3 leading-tight text-primary-600 bg-primary-50--}}
        {{--                 border border-primary-300 hover:bg-primary-100 hover:text-primary-700 dark:border-gray-700 dark:bg-gray-700--}}
        {{--                 dark:text-white">3</a>--}}
        {{--            </li>--}}
        {{--            <li>--}}
        {{--              <a href="#"--}}
