...
@section("content")
  <!-- Start block -->
  <section id="module" class=" dark:bg-gray-900 p-3 sm:p-5 container">
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
      <h2 class="form__header mb-20">Liste des modules</h2>
      <!-- Start coding here -->
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tr>
              ...
              <th scope="col" class="px-4 py-3">coefficient</th>
            ...
            @foreach($modules as $module)
              <tr class="border-b dark:border-gray-700">
                ...
                <td class="px-4 py-3">{{$module->libelle}}</td>
                <td class="px-4 py-3 font-bold">{{$module->coefficient}}</td>
                <td class="px-4 py-3 "><span class="flex items-baseline gap-1">
                    <span
                      class="inline-block rounded-full w-2.5 h-2.5 bg-{{$module->status === "active" ? "green" : "red"}}-500"></span> {{$module->status}}</span>
                </td>
                <td class="px-4 py-3 flex items-center justify-end">
                  @auth
                    <button id="module-{{$module->id}}-dropdown-button"
                            data-dropdown-toggle="module-{{$module->id}}-dropdown"
                    ...
                    <div id="module-{{$module->id}}-dropdown"
                         class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                      <ul data-module="{{$module}}" class="py-1 text-sm"
                          aria-labelledby="module-{{$module->id}}-dropdown-button">
                        <li>
      ...
      <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
        ...
        <form action="{{route("modules.store")}}" method="post">
          ...
          <div class="grid gap-4 mb-4 sm:grid-cols-2">
            <div>
              <label for="libelle" class="block capitalize mb-2 text-sm font-medium text-gray-900 dark:text-white">libelle</label>
            ...
            <div>
              <label for="coefficient"
                     class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Coefficient</label>
              <input type="text" name="coefficient" id="coefficient" class="form__input--type2">
              @error('coefficient')
              <span class="text-red-500 text-xs italic">{{ $message }}</span>
              @enderror
            </div>
            <div>
              <label for="status"
                     class="block mb-4 text-sm font-medium text-gray-900 dark:text-white">Status</label><select
                id="status"
                name="status"
                class="form__input--type2">
  ...
  <div id="updateProductModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      ...
      <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
        <!-- Modal header -->
        <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Update module</h3>
          <button type="button"
                  class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                  data-modal-toggle="updateProductModal">
            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewbox="0 0 20 20"
    ...
    <div class="relative p-4 w-full max-w-xl max-h-full">
      ...
      <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
        ...
        <div>
          ...
          <p class="mb-4">
            Libelle :
            <span id="readLibelle" class="font-regular text-gray-500 dark:text-gray-400"></span>
          </p>
          <p class="mb-3">
            Coefficient :
            <span id="readCoefficient" class="font-light leading-none text-gray-600 dark:text-white"></span>
          </p>
          <p class="mb-3">
            Status :
