...
@section("content")
  <!-- Start block -->
  <section id="note" class=" dark:bg-gray-900 p-3 sm:p-5 container">
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
      <h2 class="form__header mb-20">Liste des notes</h2>
      <!-- Start coding here -->
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tr>
              ...
              <th scope="col" class="px-4 py-3">date d'examen</th>
            ...
            @foreach($notes as $note)
              <tr class="border-b dark:border-gray-700">
                ...
                <td class="px-4 py-3">{{$note->stagiaire->nom . " " . $note->stagiaire->prenom}}</td>
                <td class="px-4 py-3">{{$note->module->libelle}}</td>
                <td class="px-4 py-3 font-bold">{{$note->note}}</td>
                <td class="px-4 py-3">{{$note->date_exam}}</td>
                <td class="px-4 py-3 flex items-center justify-end">
                  <button id="note-{{$note->id}}-dropdown-button"
                          data-dropdown-toggle="note-{{$note->id}}-dropdown"
                  ...
                  <div id="note-{{$note->id}}-dropdown"
                       class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                    <ul data-note="{{$note}}" class="py-1 text-sm"
                        aria-labelledby="note-{{$note->id}}-dropdown-button">
                      <li>
      ...
      <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
        ...
        <form action="{{route("notes.store")}}" method="post">
          ...
          <div class="grid gap-4 mb-4 sm:grid-cols-2">
            <div>
              <label for="stagiaire"
                     class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">stagiaire</label>
              <select
                id="stagiaire"
                name="stagiaire_id"
            ...
            <div>
              <label for="module" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">module</label>
              <select
                id="module"
                name="module_id"
                class="form__input--type2">
            ...
            <div class="mb-4">
              <label for="date_exam"
                ...
                d'examen</label>
              <input type="date" name="date_exam" id="date_exam"
                     class="form__input--type2">
              @error('date_exam')
              <span class="text-red-500 text-xs italic">{{ $message }}</span>
              @enderror
  ...
  <div id="updateProductModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      ...
      <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
        <!-- Modal header -->
        <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Update note</h3>
          <button type="button"
                  class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                  data-modal-toggle="updateProductModal">
            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewbox="0 0 20 20"
    ...
    <div class="relative p-4 w-full max-w-xl max-h-full">
      ...
      <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
        ...
        <div>
          ...
          <p class="mb-3">
            Module :
            <span id="readModule" class="font-light leading-none text-gray-600 dark:text-white"></span>
          </p>
          <p class="mb-3">
            Note :
            <span id="readNote" class="font-light text-gray-600  dark:text-gray-400"></span>
          </p>
          <p class="mb-5">
            Date d'examen :
            <span id="readDateExam" class="font-light text-gray-600  dark:text-gray-400"></span>
          </p>
        </div>
      </div>
    </div>
